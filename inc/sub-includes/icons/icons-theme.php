...
if ( ! function_exists( 'oktan_filter_icons_icon_set' ) ) :
function oktan_filter_icons_icon_set( $sets ) {
	$sets['theme-fa-icons'] = array(
		...
		'groups'          => array(
			'web-application' => esc_html__( 'Web Application Icons', 'oktan' ),

			'hand'            => esc_html__( 'Hand Icons', 'oktan' ),
			'transportation'  => esc_html__( 'Transportation Icons', 'oktan' ),
			'gender'          => esc_html__( 'Gender Icons', 'oktan' ),
			'file-type'       => esc_html__( 'File Type Icons', 'oktan' ),

			'payment'         => esc_html__( 'Payment Icons', 'oktan' ),

			'currency'        => esc_html__( 'Currency Icons', 'oktan' ),
			'text-editor'     => esc_html__( 'Text Editor Icons', 'oktan' ),
			'directional'     => esc_html__( 'Directional Icons', 'oktan' ),
			'video-player'    => esc_html__( 'Video Player Icons', 'oktan' ),
			'brand'           => esc_html__( 'Brand Icons', 'oktan' ),
			'medical'         => esc_html__( 'Medical Icons', 'oktan' ),
			'flaticon'        => esc_html__( 'Flat Icons', 'oktan' ),
			'icomoon'        => esc_html__( 'Icomoon Icons', 'oktan' ),
			'icon-fonts'        => esc_html__( 'Fontello Icons', 'oktan' ),
		),
		'icons'           => array(
			...
			'fa fa-telegram'                          => array( 'group' => 'web-application' ),
			...
			'ico-refinery' =>array('group' => 'icomoon'),
			'ico-tank' =>array('group' => 'icomoon'),
			'ico-oil' =>array('group' => 'icomoon'),
			'ico-pipe' =>array('group' => 'icomoon'),
			'ico-oil-tanker' =>array('group' => 'icomoon'),
			'ico-extraction' =>array('group' => 'icomoon'),
			'ico-power-plant' =>array('group' => 'icomoon'),
			'ico-electric-factory' =>array('group' => 'icomoon'),
			'ico-water-factory' =>array('group' => 'icomoon'),
			'ico-location' =>array('group' => 'icomoon'),
			'ico-call' =>array('group' => 'icomoon'),
			'ico-email' =>array('group' => 'icomoon'),





'icon-cancel' => array('group' => 'icon-fonts'),
'icon-shopping-bag' => array('group' => 'icon-fonts'),
'icon-minus' => array('group' => 'icon-fonts'),
'icon-prohibition' => array('group' => 'icon-fonts'),
'icon-placeholder' => array('group' => 'icon-fonts'),
'icon-like' => array('group' => 'icon-fonts'),
'icon-star-full' => array('group' => 'icon-fonts'),
'icon-double-angle-pointing-to-right' => array('group' => 'icon-fonts'),
'icon-delivery-truck-1' => array('group' => 'icon-fonts'),
'icon-double-left-chevron' => array('group' => 'icon-fonts'),
'icon-clock-1' => array('group' => 'icon-fonts'),
'icon-pencil' => array('group' => 'icon-fonts'),
'icon-linkedin' => array('group' => 'icon-fonts'),
'icon-twitter' => array('group' => 'icon-fonts'),
'icon-skype' => array('group' => 'icon-fonts'),
'icon-pinterest' => array('group' => 'icon-fonts'),
'icon-search' => array('group' => 'icon-fonts'),
'icon-gplus' => array('group' => 'icon-fonts'),
'icon-rss' => array('group' => 'icon-fonts'),
'icon-youtube' => array('group' => 'icon-fonts'),
'icon-vimeo' => array('group' => 'icon-fonts'),
'icon-instagram' => array('group' => 'icon-fonts'),
'icon-user' => array('group' => 'icon-fonts'),
'icon-calendar' => array('group' => 'icon-fonts'),
'icon-food' => array('group' => 'icon-fonts'),
'icon-customer-service' => array('group' => 'icon-fonts'),
'icon-phone-call' => array('group' => 'icon-fonts'),
'icon-refresh' => array('group' => 'icon-fonts'),
'icon-basket' => array('group' => 'icon-fonts'),
'icon-navigate-up-arrows' => array('group' => 'icon-fonts'),
'icon-spa' => array('group' => 'icon-fonts'),
'icon-order' => array('group' => 'icon-fonts'),
'icon-arrow-down-sign-to-navigate' => array('group' => 'icon-fonts'),
'icon-arrow-point-to-right' => array('group' => 'icon-fonts'),
'icon-question-mark' => array('group' => 'icon-fonts'),
'icon-angle-arrow-down' => array('group' => 'icon-fonts'),
'icon-quotations' => array('group' => 'icon-fonts'),
'icon-envelope' => array('group' => 'icon-fonts'),
'icon-telephone' => array('group' => 'icon-fonts'),
'icon-list-1' => array('group' => 'icon-fonts'),
'icon-placeholder-1' => array('group' => 'icon-fonts'),
'icon-candy' => array('group' => 'icon-fonts'),
'icon-search-1' => array('group' => 'icon-fonts'),
'icon-cigar' => array('group' => 'icon-fonts'),
'icon-tags' => array('group' => 'icon-fonts'),
'icon-close-1' => array('group' => 'icon-fonts'),
'icon-comment-white-oval-bubble' => array('group' => 'icon-fonts'),
'icon-right-arrow-1' => array('group' => 'icon-fonts'),
'icon-cigarette' => array('group' => 'icon-fonts'),
'icon-conserve' => array('group' => 'icon-fonts'),
'icon-bookmark-button' => array('group' => 'icon-fonts'),
'icon-delete' => array('group' => 'icon-fonts'),
'icon-back' => array('group' => 'icon-fonts'),
'icon-checked-1' => array('group' => 'icon-fonts'),
'icon-login' => array('group' => 'icon-fonts'),
'icon-delivery-package-opened' => array('group' => 'icon-fonts'),
'icon-logout' => array('group' => 'icon-fonts'),
'icon-menu-1' => array('group' => 'icon-fonts'),
'icon-menu-button-of-three-horizontal-lines' => array('group' => 'icon-fonts'),
'icon-security-on' => array('group' => 'icon-fonts'),
'icon-lotus' => array('group' => 'icon-fonts'),
'icon-clock-2' => array('group' => 'icon-fonts'),
'icon-shop-basket' => array('group' => 'icon-fonts'),
'icon-list' => array('group' => 'icon-fonts'),
'icon-icon' => array('group' => 'icon-fonts'),
'icon-up-arrow-1' => array('group' => 'icon-fonts'),
'icon-clock' => array('group' => 'icon-fonts'),
'icon-pencil-1' => array('group' => 'icon-fonts'),
'icon-left-arrow' => array('group' => 'icon-fonts'),
'icon-right-arrow' => array('group' => 'icon-fonts'),
'icon-up-arrow' => array('group' => 'icon-fonts'),
'icon-avatar' => array('group' => 'icon-fonts'),
'icon-headache-1' => array('group' => 'icon-fonts'),
'icon-herbal' => array('group' => 'icon-fonts'),
'icon-profile' => array('group' => 'icon-fonts'),
'icon-location' => array('group' => 'icon-fonts'),
'icon-musica-searcher' => array('group' => 'icon-fonts'),
'icon-shopping-cart' => array('group' => 'icon-fonts'),
'icon-eye' => array('group' => 'icon-fonts'),
'icon-leaf' => array('group' => 'icon-fonts'),
'icon-globe' => array('group' => 'icon-fonts'),
'icon-shopping-bag-1' => array('group' => 'icon-fonts'),
'icon-users-1' => array('group' => 'icon-fonts'),
'icon-phone' => array('group' => 'icon-fonts'),
'icon-shield-1' => array('group' => 'icon-fonts'),
'icon-switch-arrows' => array('group' => 'icon-fonts'),
'icon-star' => array('group' => 'icon-fonts'),
'icon-marijuana' => array('group' => 'icon-fonts'),
'icon-skip-track' => array('group' => 'icon-fonts'),
'icon-plus' => array('group' => 'icon-fonts'),
'icon-magnifying-glass' => array('group' => 'icon-fonts'),
'icon-shopping-cart-1' => array('group' => 'icon-fonts'),
'icon-down-chevron' => array('group' => 'icon-fonts'),
'icon-remove' => array('group' => 'icon-fonts'),
'icon-place-localizer' => array('group' => 'icon-fonts'),
'icon-smartphone' => array('group' => 'icon-fonts'),
'icon-return' => array('group' => 'icon-fonts'),
'icon-menu' => array('group' => 'icon-fonts'),
'icon-right-dir' => array('group' => 'icon-fonts'),
'icon-tags-1' => array('group' => 'icon-fonts'),
'icon-mouse' => array('group' => 'icon-fonts'),
'icon-bar-menu' => array('group' => 'icon-fonts'),
'icon-grid' => array('group' => 'icon-fonts'),
'icon-dot' => array('group' => 'icon-fonts'),
'icon-5-point-star' => array('group' => 'icon-fonts'),
'icon-down-dir' => array('group' => 'icon-fonts'),
'icon-up-dir' => array('group' => 'icon-fonts'),
'icon-timer' => array('group' => 'icon-fonts'),
'icon-checked' => array('group' => 'icon-fonts'),
'icon-email' => array('group' => 'icon-fonts'),
'icon-distance' => array('group' => 'icon-fonts'),
'icon-call-center' => array('group' => 'icon-fonts'),
'icon-down-arrow' => array('group' => 'icon-fonts'),
'icon-down-arrow-1' => array('group' => 'icon-fonts'),
'icon-fax' => array('group' => 'icon-fonts'),
'icon-package-1' => array('group' => 'icon-fonts'),
'icon-pinterest-1' => array('group' => 'icon-fonts'),
'icon-pointed-star' => array('group' => 'icon-fonts'),
'icon-tick' => array('group' => 'icon-fonts'),
'icon-close' => array('group' => 'icon-fonts'),
'icon-angle-double-right' => array('group' => 'icon-fonts'),
'icon-angle-left' => array('group' => 'icon-fonts'),
'icon-angle-right' => array('group' => 'icon-fonts'),
'icon-angle-up' => array('group' => 'icon-fonts'),
'icon-angle-down' => array('group' => 'icon-fonts'),
'icon-quote-right' => array('group' => 'icon-fonts'),
'icon-reply' => array('group' => 'icon-fonts'),
'icon-level-down' => array('group' => 'icon-fonts'),
'icon-right-circled2' => array('group' => 'icon-fonts'),
'icon-plug' => array('group' => 'icon-fonts'),
'icon-internet-explorer' => array('group' => 'icon-fonts'),
'icon-facebook' => array('group' => 'icon-fonts')
		),
	);

	return $sets;
}
endif; //oktan_filter_icons_icon_set
add_filter( 'fw_option_type_icon_sets', 'oktan_filter_icons_icon_set' );


if ( ! function_exists( 'oktan_filter_megamenu_icon_set' ) ) {
	function oktan_filter_megamenu_icon_set( $array_set ) {
		$array_set['set'] = 'theme-fa-icons';

		return $array_set;
	}
}
add_filter( 'fw:ext:megamenu:icon-option', 'oktan_filter_megamenu_icon_set' );