...
if ( $atts['show_filters'] ) {
	...
	if ( count( $categories ) > 1 ) : ?>
		<div class="filters isotope_filters-<?php echo esc_attr( $unique_id ); ?> text-center">
			<a href="#" data-filter="*" class="active selected"><?php esc_html_e( 'All', 'oktan' ); ?></a>
...
?>
<div class="isotope-wrapper portfolio isotope row masonry-layout <?php echo esc_attr( $margin_class . ' ' . $columns_class ); ?>"
