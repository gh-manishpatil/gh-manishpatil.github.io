...
$options = array(
	'post-featured-gallery-section' => array(
		'title'   => esc_html__( 'Featured Gallery', 'oktan' ),
		'type'    => 'box',
		'context' => 'side',
		...
		'options' => array(
			'post-featured-gallery' => array(
				'type'  => 'multi-upload',
				'value' => array(),
				'label' => esc_html__('Images for featured gallery', 'oktan'),
				'desc'  => esc_html__('Display gallery carousel on single event', 'oktan'),
				/**
